...
class Installer {
  ...
  'envPrefix' => 'OVHCLOUD_WEBPAAS_CLI_',
  'manifestUrl' => 'https://eu.cli.webpaas.ovhcloud.com/manifest.json',
  'configDir' => '.webpaas-cli',
  'executable' => 'webpaas',
  'cliName' => 'OVHcloud Web PaaS CLI',
  'userAgent' => 'ovhcloud-webpaas',
)/* END_CONFIG */;
